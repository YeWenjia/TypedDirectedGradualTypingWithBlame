...
Proof.
  ...
  - inverts Val.
    ...
    forwards*: IHR1 R1 H12. inverts H5. inverts H5.
    forwards*: TypedReduce_unique H0 H11. inverts H6.
    inverts* H0.
  - inverts* R2; try solve[inverts* H4]; try solve[inverts* H5].
...
Proof.
  ...
  - (* e1 e2 ---> e1' e2 *)
    ...
    + forwards*: sfill_eq H0.             
      ...
      forwards*: Typing_chk H9. inverts H3.
  ...
  - (* \x.e v *)
    ...
    forwards*: step_not_walue H4].
    inverts Typ. inverts H2. inverts H11; try solve[inverts H5].
    inverts H12.
  ...
  - (* \x.e:a1->b1:a2->b2 v ---> e[x->v']:b1:b2 *)
    ...
    inverts H12; try solve[inverts H0].
  ...
  - (* \x.e:a1->b1:a2->b2 v --> blame *)
    ...
    forwards*: step_not_walue H4];
    try solve[inverts H];
    inverts Typ. inverts H2;inverts H12; try solve[inverts H];
    forwards*: TypeLists_unique H1 H11;congruence.
  - (* v: a *)
    inverts* Red2;
    try solve[destruct E; unfold simpl_fill in H1; inverts* H1];
