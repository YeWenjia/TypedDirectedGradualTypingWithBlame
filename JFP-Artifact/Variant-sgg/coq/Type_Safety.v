...
Proof with auto.
  ...
  gen B.
  lets Red': Red.
  inductions Red; introv Typ;try solve[inverts* Val];
...
Proof.
  ...
  - Case "typing_app".
    ...
    +
      inverts Typ1. 
      *
       inverts H2. inverts H0; inverts H.
       inverts H8; try solve[inverts H2].
      ...
      *
      inverts H. 
      inverts H9;try solve[inverts* H10]. inverts H1; try solve[inverts* H2].
      inverts H7.
      forwards*: TypeLists_preservation2 H5.
       eapply Typ_anno; eauto.
       eapply Typ_sim; eauto.
...
Proof.
  ...
  - right. inverts Lc. 
    ...
    +
      ...
      *
        ...
        try solve[inverts H4;inverts H;inverts H1];
        try solve[inverts H8].

        forwards*: TypedReduce_progress A1 Typ2. inverts* H.
        destruct x; eauto.
        forwards*: TypedReduce_preservation H4.
        forwards*: TypedReduce_prv_value H4.
        forwards*: value_nlam H6.
        forwards*: value_lc H6.
        forwards*: TypedReduce_progress e0 A. inverts H9.
        destruct x; eauto.
        ...
        forwards*: TypedReduce_progress e0 A. inverts H12.
        destruct x; eauto.

        forwards*: principle_inf2 Typ1.
      *
        inverts Typ1. inverts Val2; try solve[inverts* Typ2;inverts H5].
        forwards*: TypedReduce_progress t_dyn Typ2. inverts* H1.
        destruct x; eauto.
        inverts* H4.
        assert(principal_type (e_abs e) = (t_arrow t_dyn t_dyn ));eauto.
      * inverts Typ1; inverts Val1; try solve[inverts H0]; try solve[inverts H4].
        exists*.
    +
  ...
  -  Case "anno".
    ...
    + SCase "e_anno v A".
      ...
      inverts* Typ; try solve[inverts* H4];
