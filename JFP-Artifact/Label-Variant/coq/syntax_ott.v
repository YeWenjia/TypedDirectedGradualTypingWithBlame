...
Inductive Typing : ctx -> exp -> dirflag -> typ -> Prop :=    (* defn Typing *)
 ...
 | Typ_app : forall (G:ctx) (e1 e2:exp) (B A:typ) l b ,
     Typing G e1 Inf (t_arrow A B) ->
     Typing G e2 Chk A ->
     Typing G (e_app e1 l b e2) Inf B
...
Inductive TypedReduce : exp -> var -> bool -> typ -> res -> Prop :=    (* defn TypedReduce *)
 ...
 | TReduce_save : forall s (A C D:typ) l1 b1 l2 b2,
      sval s ->
     TypedReduce  ( (e_anno s l1 b1 A) ) l2 b2 (t_arrow C D) (Expr (e_anno s l2 b2 (t_arrow C D) ))
...
Inductive step : exp -> res -> Prop :=
   ...
   | Step_beta : forall (A1 A2:typ) (e:exp) (B1 B2:typ) (v: exp) l1 b1 l2 b2 l3 b3 v',
     lc_exp (e_abs e) ->
     walue v ->
     TypeLists v (cons (t_typs A2 l3 (negb b3)) (cons (t_typs t_dyn l2 (negb b2)) (cons (t_typs A1 l2 (negb b2)) nil))) (Expr v') ->
  ...
  | Step_betap : forall (A1 A2:typ) (e:exp) (B1 B2:typ) (v: exp) l1 b1 l2 b2 l3 b3 l b,
     lc_exp (e_abs e) ->
     walue v ->
     TypeLists v (cons (t_typs A2 l3 (negb b3)) (cons (t_typs t_dyn l2 (negb b2)) (cons (t_typs A1 l2 (negb b2)) nil))) (Blame l b) ->
...
(** infrastructure *)
Hint Constructors ssval nlam value walue Ground gvalue gwalue sval sim TypedReduce gTypedReduce gTypeLists TypeLists wellformed simpl_wf step steps gsteps tpre epre Typing gtyping lc_exp : core.
