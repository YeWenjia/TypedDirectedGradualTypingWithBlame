...
Fixpoint close_exp_wrt_exp_rec (n1 : nat) (x1 : var) (e1 : exp) {struct e1} : exp :=
  match e1 with
    ...
    | e_app e2 l b e3 => e_app (close_exp_wrt_exp_rec n1 x1 e2) l b (close_exp_wrt_exp_rec n1 x1 e3)
    | e_anno e2 l b A1 => e_anno (close_exp_wrt_exp_rec n1 x1 e2) l b A1
    | e_add e2 l1 b1 e3 l2 b2=> e_add (close_exp_wrt_exp_rec n1 x1 e2) l1 b1 (close_exp_wrt_exp_rec n1 x1 e3) l2 b2
  end.
...
Fixpoint size_exp (e1 : exp) {struct e1} : nat :=
  match e1 with
    ...
    | e_app e2 l b e3 => 1 + (size_exp e2) + (size_exp e3)
    | e_anno e2 l b A1 => 1 + (size_exp e2) + (size_typ A1)
    | e_add e2 l1 b1 e3 l2 b2 => 1 + (size_exp e2) + (size_exp e3)
  end.
...
Inductive degree_exp_wrt_exp : nat -> exp -> Prop :=
  ...
  | degree_wrt_exp_e_app : forall n1 e1 e2 l b,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 e2 ->
    degree_exp_wrt_exp n1 (e_app e1 l b e2)
  | degree_wrt_exp_e_anno : forall n1 e1 A1 l b,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 (e_anno e1 l b A1)
  | degree_wrt_exp_e_add : forall n1 e1 e2 l1 b1 l2 b2,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 e2 ->
    degree_exp_wrt_exp n1 (e_add e1 l1 b1 e2 l2 b2).
...
Inductive lc_set_exp : exp -> Set :=
  ...
  | lc_set_e_abs : forall e1,
    ...
    lc_set_exp (e_abs e1 )
  | lc_set_e_app : forall e1 e2 l b,
    lc_set_exp e1 ->
    lc_set_exp e2 ->
    lc_set_exp (e_app e1 l b e2)
  | lc_set_e_anno : forall e1 A1 l b,
    lc_set_exp e1 ->
    lc_set_exp (e_anno e1 l b A1)
  | lc_set_e_add : forall e1 e2 l1 b1 l2 b2,
    lc_set_exp e1 ->
    lc_set_exp e2 ->
    lc_set_exp (e_add e1 l1 b1 e2 l2 b2).
