...
Fixpoint close_exp_wrt_exp_rec (n1 : nat) (x1 : var) (e1 : exp) {struct e1} : exp :=
  match e1 with
    ...
    | e_pro e2 e3 => e_pro (close_exp_wrt_exp_rec n1 x1 e2) (close_exp_wrt_exp_rec n1 x1 e3)
...
Fixpoint size_exp (e1 : exp) {struct e1} : nat :=
  match e1 with
    ...
    | e_pro e2 e3 => 1 + (size_exp e2) + (size_exp e3)
...
Inductive degree_exp_wrt_exp : nat -> exp -> Prop :=
 ...
 | degree_wrt_exp_e_pro : forall n1 e1 e2,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 e2 ->
    degree_exp_wrt_exp n1 (e_pro e1 e2)
 | degree_wrt_exp_e_l : forall n1 e1,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 (e_l e1)
 | degree_wrt_exp_e_r : forall n1 e1,
    degree_exp_wrt_exp n1 e1 ->
...
Inductive lc_set_exp : exp -> Set :=
  ...
  | lc_set_e_pro : forall e1 e2,
    lc_set_exp e1 ->
    lc_set_exp e2 ->
    lc_set_exp (e_pro e1 e2)
  | lc_set_e_l : forall e1,
    lc_set_exp e1 ->
    lc_set_exp (e_l e1)
  | lc_set_e_r : forall e1,
    lc_set_exp e1 ->
    lc_set_exp (e_r e1).
