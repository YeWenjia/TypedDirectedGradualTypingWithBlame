...
Proof.
  ...
  - 
    ...
    destruct(eq_type A1); destruct (eq_type A2); subst.
    apply gstep_b. apply gStep_annov; eauto.
...
Proof with eauto.
  ...
  -
     ...
     *
     inverts H6.
     forwards*: gtyping_regular_1 H9. inverts H8. 
...
(* 
Theorem variant_calculus_final: forall e dir A,
 gtyping nil (trans e) dir A -> e ->* Blame 
 -> (trans e) ->** Blame.
Proof with eauto.
 introv typ red1. gen dir A.
 inductions red1; intros.
 - forwards*: variant_calculus H.
Qed. *) *)