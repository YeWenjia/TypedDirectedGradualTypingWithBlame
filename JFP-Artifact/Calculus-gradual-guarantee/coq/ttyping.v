...
Proof.
  ...
  -  forwards*: IHttyping.
    ...
    inverts H5.
    inductions e; eauto.
    unfold subst_exp in H6.
    destruct(x == z). inverts e. inverts H6.
    exfalso. apply H1. exists*.
    inverts H6. 
    unfold subst_exp in H6; simpl; eauto.
    fold subst_exp in H6.
    inverts H6.
    unfold subst_exp in H6; simpl; eauto.
    fold subst_exp in H6.
    inverts H6.
  ...
  - 
    forwards*: ttsubst_value H4.
    forwards*: ttsubst_value H5.
    rewrite H6. rewrite H7.
    forwards*: ttsubst_valuer H4.
    forwards*: ttsubst_valuer H5.
...
Proof.
  intros E e u uu t dir S T z H1 H2 H3.
  rewrite_env (nil ++ E).
...
Theorem elaboration_soundness : forall G e t dir A,
    ttyping G e dir A t ->
    Btyping G t A.
Proof.
  introv Ty1.
