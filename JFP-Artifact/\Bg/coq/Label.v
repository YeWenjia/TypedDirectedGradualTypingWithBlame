...
Lemma nnlam_nlam_erase: forall e,
 nnlam e ->
 not(exists e', (erase e) = (e_abs e'))  .
Proof.
 introv nl.
 inductions nl; try solve[unfold not;intros nt;inverts* nt;inverts* H].
Qed.
...
Proof.
 ...
 rewrite <- erase_open; eauto.
 -
 forwards*: nnlam_nlam_erase H0.
Qed.


Lemma principal_pprincipal: forall v,
 pprincipal_type v = 
 principal_type (erase v).
Proof.
 introv.
 inductions v; eauto.
Qed.
...
Theorem bgl_to_bg_casting: forall e r A l b, 
 TTypedReduce e l b A r ->
 TypedReduce (erase e) A (eraser r).
Proof.
 introv red.
 ...
 rewrite principal_pprincipal in H; eauto.
 -
 forwards*: nnlam_nlam_erase H1.
 rewrite principal_pprincipal in H0; eauto.
 -
 forwards*: nnlam_nlam_erase H.
