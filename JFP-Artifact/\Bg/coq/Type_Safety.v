...
Proof.
  ...
  - inverts Typ. 
    + inverts H5.
      ...
      eapply Typ_app with (A := (t_arrow t_int (t_arrow t_int t_int))); eauto.
    ...
    + inverts H1. inverts H8. inverts H6. 
      ...
      forwards*: TypedReduce_preservation H0.
      inverts H5. inverts H4. inverts H6.
      eapply  Typ_sim; eauto.
      apply Typ_anno; eauto.
      apply Typ_sim with (A := (t_arrow t_int t_int)).
      eapply Typ_app with (A := (t_arrow t_int (t_arrow t_int t_int))); eauto.
  ...
  - inverts Typ. 
    + inverts H5. inverts H3. 
      ...
      eapply Typ_app with (A := t_arrow t_int t_int); eauto.
      inverts H4. inverts H2. inverts H3.
      eapply Typ_sim; eauto. apply BA_AB; auto.
      forwards*: TypedReduce_nlambda H0.
      inverts H4. inverts H2; inverts* H3.
      unfold not; intros nt; inverts nt. inverts H2.
    + inverts H1. inverts H8. inverts H6. inverts H5; inverts H1. inverts H4. 
      forwards*: TypedReduce_preservation H0.
      eapply  Typ_sim; eauto.
      apply Typ_anno; eauto.
  ...
  - inverts Typ. inverts H7.
    ...
    eapply Typ_sim; eauto.
    forwards*: TypedReduce_nlambda H0.
  - inverts Typ. inverts H5. inverts H3.
    forwards*: TypedReduce_preservation H0.
    inverts H1. inverts H8. inverts H6. 
    eapply Typ_sim;eauto.
    unfold not; intros nt; inverts nt. inverts H4.
  - inverts Typ. inverts H5. inverts H3.
    ...
    unfold not; intros nt; inverts nt. inverts H1.
  - inverts Typ. 
    + inverts H6. inverts H4. inverts H5. inverts H2. inverts H7.
      * 
      inverts* H3. inverts H. 
      apply Typ_anno; eauto.
      eapply Typ_sim; eauto.
      ...
      *
      ...
      eapply Typ_app with (A :=  (t_arrow A B)); eauto.
      apply Typ_sim with (A := A1); eauto.
      apply BA_AB; auto.
      forwards*: TypedReduce_nlambda H0.
      unfold not; intros nt; inverts nt. inverts H7.
      (* *
      inverts H5. inverts H10. inverts H5. inverts H6.
      forwards*: TypedReduce_preservation H0.
      apply Typ_anno;eauto. 
      apply Typ_sim with (A:= B); eauto.
    ...
    + inverts H2. inverts H9. inverts H7. inverts H6.
      inverts H2. inverts H5. inverts H9.
      * 
        eapply Typ_sim; eauto.
        apply Typ_anno; eauto.
        eapply Typ_sim; eauto.
    ...
    -
      ...
      eapply Typ_app with (A := (t_arrow t_dyn t_dyn));eauto.
...
Proof.
  ...
  - right. inverts Lc.
    ...
    +  forwards*: TypedReduce_progress Typ2.
        ...
        inverts* H1. inverts H11. inverts H8.
        inverts H10. inverts* H10. inverts H8. inverts H10.
    ...
    +  forwards*: TypedReduce_progress Typ2.
        ...
        inductions x.
        inverts Typ2.
        inverts* H1; try solve [inverts* H9; inverts H3].
        inverts H9. inverts H6. inverts H8.
        inverts* H7. inverts H6. inverts H9.
        inverts Val2. inverts H8; inverts* H6.
